...
#   security_group_ids = var.security_groups  # Use security groups instead of route tables
#   subnet_ids         = aws_subnet.public[*].id  # Ensure these are subnet IDs
...
#   security_group_ids = var.security_groups   # Add your security group if necessary
